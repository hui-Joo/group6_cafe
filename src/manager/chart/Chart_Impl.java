...
public class Chart_Impl implements Chart {
	...
	public void menuChart(Parent root) {
		...
		menuChart.setData(FXCollections.observableArrayList(new PieChart.Data("Americano", americano),
				new PieChart.Data("Latte", latte), new PieChart.Data("Capucino", capucino),
				new PieChart.Data("VanilaLatte", vanilaLatte)));
	...
	public void totalChart(Parent root) {
		...
		priceChart.setData(FXCollections.observableArrayList(new XYChart.Data("Hot", hot),
				new XYChart.Data("Ice", ice * price_ice), new XYChart.Data("Americano", americano * price_americano),
				new XYChart.Data("Latte", latte * price_latte), new XYChart.Data("Capucino", capucino * price_capucino),
				new XYChart.Data("VanilaLatte", vanilaLatte * price_vanilaLatte), new XYChart.Data("Small", small),
				new XYChart.Data("Regular", regular * price_regular), new XYChart.Data("Large", large * price_large)));
		...
		labelPriceTotal.setText(americano * price_americano + latte * price_latte + capucino * price_capucino
				+ vanilaLatte * price_vanilaLatte + ice * price_ice + regular * price_regular + large * price_large
				+ "won");
	}
	...
	public void HISChart(Parent root) {
		...
		hotIceChart.setData(
				FXCollections.observableArrayList(new PieChart.Data("hot", hot), new PieChart.Data("ice", ice)));
		...
		sizeChart.setData(FXCollections.observableArrayList(new PieChart.Data("small", small),
				new PieChart.Data("regular", regular), new PieChart.Data("large", large)));
